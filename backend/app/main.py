...
from app.routers import auth, companies, cv, diary, feedback, institutions, jobs, myrology, newsletter, payments, profile, scores, skills, status, telemetry, users, xp
