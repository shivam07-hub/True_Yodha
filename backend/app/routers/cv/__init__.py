...
from .phrasings import router as phrasings_router
from .reservoir_status import router as reservoir_status_router
...
router.include_router(reservoir_status_router)
