...
| 10 | Inter / Geist / Space Grotesk | **Paid down 2026-09-12.** Product UI is the platform stack at every width (`--tm-font-sans`). Grotesk and Inter unloaded. Geist remains on the CV sheet/PDF only — a document, not chrome. Mitigation for the leftover: 6-rung scale (12/14/18/24/32), no 700+, no italics, mono only on numerals. |
