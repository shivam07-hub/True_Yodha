...
- **PR-QUEST-BOARD** — daily-missions widget on `/home`, derived client-side from `useHomeBootstrap`. **ND4** (layout).
...
**Open decisions for Shivam:** ND4 quest layout · ND5 landing-preview format · ND6 PLANNED referral row · ND9 exact 10 domain names · ~~ND13 tour scope~~ (RESOLVED 2026-06-20 — no nav tour, superseded by FirstRunHero) · ND14 signup scope · ND15 accent-toggle timing.
