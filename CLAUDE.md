...
- **PR-BASE-TOUR** — 3-step first-run coachmark tour (home→forge→market; 650ms, step dots, scrim). Spec: `reference/building-10-min-cv-onboarding-extracted/design_handoff_progressive_nav/README.md`. Highest-impact unbuilt retention item ("30/30 users didn't know what to do"). Decision **ND13**.
...
**Open decisions for Shivam:** ND4 quest layout · ND5 landing-preview format · ND6 PLANNED referral row · ND9 exact 10 domain names · ND13 tour scope · ND14 signup scope · ND15 accent-toggle timing.
