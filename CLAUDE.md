...
**Open — QA (real device):**
- **BUG-10** — feedback-form category cards reported broken on Android Chrome. Code is a valid `<button onClick>`; suspect z-index / pointer-events passthrough on the hub overlay (`components/feedback/feedback-hub.tsx`). Needs a live phone repro, not a rewrite.
...
- **BUG-2 residual** — Android upload interrupt; needs prod telemetry reasonCode, not more retries.
...
- **PR-LANDING-DEPTH** — trust badge "Free to start" (T1) · "what you're scored on" 10-domain chips (T2/**ND9**) · social-proof count (T3) · FAQ accordion (5 Qs) · 3-step "how it works" · 3 beta testimonials. All unbuilt.
