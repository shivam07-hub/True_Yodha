...
const NAV = [
  ...
  { id: "not-an-agency",  n: "07", title: "Not an Employer" },
  { id: "disclaimer",     n: "08", title: "Disclaimers" },
  { id: "liability",      n: "09", title: "Limitation of Liability" },
  { id: "indemnity",      n: "10", title: "Indemnification" },
  { id: "security",       n: "11", title: "Data Security" },
  { id: "governing-law",  n: "12", title: "Governing Law" },
  { id: "termination",    n: "13", title: "Termination" },
  { id: "changes",        n: "14", title: "Changes" },
      ...
      <header className="relative overflow-hidden px-4 lg:px-8 pt-16 lg:pt-20 pb-12">
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: "var(--tm-content-max)", margin: "0 auto" }}>
          ...
          <p style={{ fontSize: "var(--tm-fs-meta)", color: "var(--tm-text-muted)", margin: 0 }}>
            Effective 4 May 2026 · Last updated 30 May 2026
          </p>
        </div>
      </header>
        ...
        <div className="flex flex-col lg:grid gap-10 lg:gap-14" style={{ gridTemplateColumns: "220px 1fr", alignItems: "start" }}>
          ...
          <main style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div style={{ background: "var(--tm-int-bg-wash)", border: "1px solid var(--tm-int-border)", borderRadius: "var(--tm-radius-lg)", padding: "18px 20px", display: "flex", gap: 14, alignItems: "flex-start" }}>
              ...
              <div>
                ...
                <p style={{ margin: 0, fontSize: "var(--tm-fs-meta)", color: "var(--tm-text-muted)", lineHeight: 1.5 }}>
                  We are a software tool. We do not guarantee jobs, interviews, or responses. Every hiring decision belongs to the employer — see Section 07.
                </p>
              </div>
            </div>

            <Section id="acceptance" n="01" title="Acceptance of Terms">
              <P>Myro (the &ldquo;Service&rdquo;) is operated by <strong>Myro Career Intelligence</strong>, Vasant Vihar, West Delhi, Delhi, India (&ldquo;Myro&rdquo;, &ldquo;we&rdquo;, &ldquo;us&rdquo;). By accessing or using the Service, you agree to these Terms. If you do not agree, do not use the Service.</P>
            </Section>
            ...
            <Section id="ip" n="06" title="Intellectual Property">
              <P>The Myro platform, branding, and software are owned by Myro Career Intelligence and protected by applicable law. Nothing in these Terms grants you rights in Myro&rsquo;s IP beyond the limited right to use the Service.</P>
            </Section>

            <Section id="not-an-agency" n="07" title="Myro Is Not an Employer or Recruiter">
            ...
            <Section id="disclaimer" n="08" title="Disclaimers">
            ...
            <Section id="liability" n="09" title="Limitation of Liability">
            ...
            <Section id="indemnity" n="10" title="Indemnification">
            ...
            <Section id="security" n="11" title="Data Security">
            ...
            <Section id="governing-law" n="12" title="Governing Law &amp; Jurisdiction">
            ...
            <Section id="termination" n="13" title="Termination">
              <P>You may delete your account at any time. We may suspend or terminate accounts that violate these Terms. On termination, your right to use the Service ends immediately. Sections that by their nature should survive termination (including Disclaimers, Limitation of Liability, Indemnification, and Governing Law) will survive.</P>
            </Section>

            <Section id="changes" n="14" title="Changes to Terms">
