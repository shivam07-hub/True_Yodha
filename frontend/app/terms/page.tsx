...
const NAV = [
  ...
  { id: "payments",       n: "07", title: "Payments & XP" },
      ...
      <div className="px-4 lg:px-8 pb-20" style={{ maxWidth: "var(--tm-content-max)", margin: "0 auto" }}>
        <div className="flex flex-col lg:grid gap-10 lg:gap-14" style={{ gridTemplateColumns: "220px 1fr", alignItems: "start" }}>
          ...
          <main style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <Section id="payments" n="07" title="Payments, XP &amp; Refunds">
              <Sub title="What you are buying" />
              <P>Myro runs on an in-platform credit called <strong>XP</strong>. XP is a digital, consumable credit used to unlock optional features (such as company follows, match refreshes, focused practice sessions, and premium reports). <strong>XP is not money, not legal tender, and not a financial instrument.</strong> It has no cash value, is non-transferable, cannot be exchanged for cash, and exists only inside the Service. You may also earn XP for free through ordinary use of the Service.</P>
              <P>XP is a <strong>closed-loop, single-merchant utility credit</strong> usable only inside Myro to unlock Myro&rsquo;s own software features. It cannot be transferred to any other person, loaded onto any card or wallet, used at any third party, or redeemed for cash, goods, or services outside the Service. XP is <strong>not a prepaid payment instrument</strong> under the Reserve Bank of India&rsquo;s directions and is not a means of payment to any third party — it is simply a way to access features within Myro.</P>
              <Sub title="What your payment funds" />
              <P>When you buy XP or any paid feature, your payment goes towards the cost of operating Myro Career Intelligence Private Limited — including servers, infrastructure, data processing, and ongoing development. <strong>The purpose of payment is to keep the Service running so that career intelligence remains accessible and affordable. Payment does not buy, and is in no way a payment for, any job, interview, application, shortlisting, placement, response, or employment outcome.</strong> Myro sells software access only — see Section 08.</P>
              ...
              <P><strong>XP and in-platform credits.</strong> XP and paid digital features are delivered and consumed immediately on purchase. For this reason, <strong>purchases of XP are final and non-refundable</strong>, and XP cannot be cancelled once purchased. Unused XP is not refundable.</P>
