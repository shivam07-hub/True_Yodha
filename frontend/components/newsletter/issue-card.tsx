...
export function IssueCard({ issue }: IssueCardProps) {
  ...
  return (
    ...
    >
      <div style={{ fontSize: 11, color: "var(--tm-interactive)", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 8 }}>
        {issue.theme} · {date}
      </div>
      ...
      <div style={{ marginTop: 14, fontSize: 13, color: "var(--tm-interactive)", fontWeight: 500 }}>
        Read issue →
      </div>
    </Link>
  )
