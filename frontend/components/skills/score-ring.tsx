  ...
  const inner = (
    <>
      ...
      <div>
        ...
        <div style={{ fontSize: "var(--tm-fs-body)", fontWeight: 600, color: "var(--tm-text)" }}>{tier.label}</div>
        {tier.next !== null && (
          <div style={{ fontSize: "var(--tm-fs-caption)", color: "var(--tm-text-faint)", marginTop: 3 }}>
