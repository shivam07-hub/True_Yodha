...
export function GoogleAuthButton({ onClick, disabled, surface, label = "Continue with Google", lastUsed = false }: Props) {
  return (
    <button
      type="button"
      ...
      onClick={() => {
        ...
        signupEvents.oauthRedirectStarted({ provider: "google" })
        onClick()
      }}
    >
