 ...
 * exchange). It is now the full-bleed preset of the shared <TealField> primitive
 * (dashboard-loading grill Q10): one motion engine for both this and the /home
 * masked playground, so the teal motif can't drift between them. The named
 * `EdgeGlow` export is preserved here so the callback import never churns.
 */
export { EdgeGlow } from "./teal-field"
