...
export function CvTailSections({ cv, onPatch }: CvTailSectionsProps) {
  ...
  return (
    <>
      <div className="cvw-sec" id="cvw-sec-education">Education</div>
      ...
      <div className="cvw-sec" id="cvw-sec-certs">Certifications</div>
      {cv.certs.length === 0 ? (
        <EmptySection
