...
authorInitials: "M"
dataset:
  name: "India semiconductor roles by company — May 2026"
  description: "Active semiconductor roles by employer in the 20 May 2026 Myro scrape across AMD, Intel, NXP, Qualcomm, STMicroelectronics and Texas Instruments."
  spatialCoverage: "India"
  temporalCoverage: "2026-05-20"
  variableMeasured:
    - "Active semiconductor roles by employer"
  columns: ["Company", "Roles captured"]
  table:
    - ["Qualcomm", 350]
    - ["AMD", 259]
    - ["NXP Semiconductors", 168]
    - ["Texas Instruments", 136]
    - ["Intel", 99]
    - ["STMicroelectronics", 4]
faqs:
  - q: "How many semiconductor jobs are open in India in 2026?"
    a: "1,016 active semiconductor roles appeared in the 20 May 2026 batch across AMD, Intel, NXP Semiconductors, Qualcomm, STMicroelectronics and Texas Instruments. A point-in-time snapshot, not a complete count."
  - q: "Which semiconductor companies hire most in India?"
    a: "Qualcomm leads with 350 roles, then AMD (259), NXP (168), Texas Instruments (136), Intel (99) and STMicroelectronics (4). Qualcomm's count is a floor — the source returned a 403 at offset 360 — and NVIDIA and Micron were blocked, so the full ranking is still open."
  - q: "Which Indian cities have the most chip jobs?"
    a: "Bengaluru (538 roles, 53.0%) and Hyderabad (332, 32.7%) dominate — 85.6% of the batch combined. Then Noida (53), Pune (42) and Chennai (31). Qualcomm and AMD explain most of Hyderabad's weight."
  - q: "What skills do semiconductor jobs in India require?"
    a: "Top primary skills at required levels 2–4: Design Verification (131 mentions), Real-Time Computing (89), Analog Design (66), Software Engineering (55), Design for Excellence (54) and Physical Design (44)."
  - q: "Are semiconductor jobs only hardware roles?"
    a: "No. Software Engineering (404 roles) and IT & Infrastructure (136) lead the role mix — software plus IT is 540 roles against 62 in manufacturing. A large platform and systems-software workload sits next to classic chip design and verification."
keyStats:
  - value: "1,016"
    label: "active semiconductor roles"
  - value: "350"
    label: "Qualcomm roles — the most"
  - value: "538"
    label: "roles in Bengaluru"
  - value: "85.6%"
    label: "of roles in Bengaluru + Hyderabad"
---
...
For a wider market comparison, read the earlier hiring map on [30,000+ India jobs](/newsletter/2026-05-hiring-map-5-surprises) and the fintech snapshot on [257 India fintech roles](/newsletter/2026-05-fintech-hiring-india).
