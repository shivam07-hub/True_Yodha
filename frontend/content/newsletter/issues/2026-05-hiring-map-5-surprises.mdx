...
keyStats:
  - value: "4,200"
    label: "of 9,446 jobs are India-based"
  - value: "1,594"
    label: "jobs at Accenture + Cognizant + DXC"
  - value: "229"
    label: "tags for \"Collaboration\", only 3 primary"
  - value: "51%"
    label: "share held by the top 5 industries"
---
