...
Pick a role and a city from this issue. Run them through Myro. We will return your top five skill gaps against the actual primary requirements in our dataset, ranked by which gap closes a job match fastest.
