...
export function ApplyCapturePromptMobile({ capture }: { capture: ApplyCapture }) {
  ...
  if (capture.state === "closed") {
    return (
      <div style={{ ...row, justifyContent: "space-between" }} role="status">
        <span style={{ color: "var(--mm-bad)", fontWeight: 600 }}>
  ...
  if (capture.state === "asking") {
    return (
      <div style={row}>
        <span style={{ color: "var(--mm-text)", fontWeight: 600 }}>Did you submit?</span>
  ...
  if (capture.state === "issue") {
    return (
      <div style={row}>
        <span style={{ color: "var(--mm-text)", fontWeight: 600 }}>What blocked you?</span>
...
const link: React.CSSProperties = {
  ...
  fontSize: "var(--tm-fs-caption)", fontWeight: 600, cursor: "pointer", fontFamily: "inherit",
}

const row: React.CSSProperties = {
  display: "flex", alignItems: "center", gap: 10, flexWrap: "wrap",
  padding: "12px 4px", borderTop: "1px solid var(--mm-hair)",
  fontSize: "var(--tm-fs-caption)", fontFamily: "inherit",
}
