  ...
  return (
    <BottomSheet open={open} onClose={onClose} label="Add job">
      <div style={{ padding: "0 18px 18px" }}>
        <div style={{ fontSize: "var(--tm-fs-heading)", fontWeight: 600, letterSpacing: "-0.02em", marginTop: 4 }}>Add a job</div>
        <div style={{ fontSize: "var(--tm-fs-caption)", color: "var(--mm-faint)", marginTop: 2 }}>Anything you add lands in Collections, ready to tailor.</div>
        ...
        {pasteMode ? (
          ...
          <button onClick={() => setPasteMode(true)} style={{ marginTop: 10, background: "none", border: "none", padding: 0, color: "var(--mm-muted)", fontSize: "var(--tm-fs-caption)", fontWeight: 600, cursor: "pointer", fontFamily: "inherit", textDecoration: "underline", textUnderlineOffset: 3 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, width: "100%", marginTop: 12, padding: "12px", borderRadius: 10, border: "1px solid var(--mm-border)" }}>
          ...
          <span style={{ flex: 1 }}>
            ...
            <span style={{ display: "block", fontSize: "var(--tm-fs-caption)", color: "var(--mm-faint)", marginTop: 1 }}>Save from any job board in one tap</span>
          </span>
        </div>
      </div>
    </BottomSheet>
