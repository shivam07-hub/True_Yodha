/** Shared constants for the Gmail MCP server. */

export const SERVER_NAME = "gmail-pathak7july-mcp-server";
export const SERVER_VERSION = "1.0.0";

/** Maximum characters returned in a single tool response before truncation. */
export const CHARACTER_LIMIT = 25_000;

/** Maximum characters of a single message body returned by mail_get_message. */
