 ...
 *
 * MCP stdio server exposing a Gmail mailbox (imap.gmail.com /
...
import { MailImap } from "./services/imap.js";
import { MailSmtp } from "./services/smtp.js";
...
async function main(): Promise<void> {
  ...
  const ctx: ServerContext = {
    config,
    imap: new MailImap(config),
    smtp: new MailSmtp(config),
  };
