"""
llm_provider.py — Unified LLM call interface for the backend pipeline.

Supported providers  (set via LLM_PROVIDER env var):
  anthropic  →  Claude
  openai     →  GPT   (default — preserves existing behaviour)
...
def get_model(provider: str | None = None) -> str:
    ...
    return override if override else _DEFAULTS.get(p, _DEFAULTS["openai"])
